...
const WidgetsList = ({ children }) => {
  ...
  return (
    <>
      <div className="mt-20 ml-8 mr-8 w-Full p-2 pt-4">
        {Object.keys(widgets).map((folder) => {
          const currentFolder = widgets[folder];
          return (
            <>
              <span className="bg-grey3 text-gray-800 text-xs mr-2 px-2.5 py-0.5 rounded dark:bg-gray1 dark:text-gray3 border border-grey2">
